...
A React interface concept for discovering emergency-service information, paramedics, and related resources. This repository is the `learn_website` version in a family of related frontend iterations.
...
```sh
git clone https://github.com/CyberTekena/learn_website.git
cd learn_website
npm install
npm run dev
```
